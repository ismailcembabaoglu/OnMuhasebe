...
namespace OnMuhasebe.Persistence.Migrations
{
    ...
    [Migration("20240601115107_mig_productmodeledit2")]
    partial class mig_productmodeledit2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.ProductGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9318),
                            CreatedUser = "Admin",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.ProductUnderGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9333),
                            CreatedUser = "Admin",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.Unit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9347),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "ADET"
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9357),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "KG"
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9367),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "Paket"
                        });
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9269),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 11, 51, 7, 346, DateTimeKind.Utc).AddTicks(9304),
                            CreatedUser = "Admin",
                            IsDeleted = false,
