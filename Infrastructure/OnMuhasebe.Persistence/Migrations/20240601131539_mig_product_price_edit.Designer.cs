...
namespace OnMuhasebe.Persistence.Migrations
{
    ...
    [Migration("20240601131539_mig_product_price_edit")]
    partial class mig_product_price_edit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.ProductGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7791),
                            CreatedUser = "Admin",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.ProductUnderGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7807),
                            CreatedUser = "Admin",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.Unit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7822),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "ADET"
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7832),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "KG"
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7841),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                            UnitName = "Paket"
                        });
            ...
            modelBuilder.Entity("OnMuhasebe.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7746),
                            CreatedUser = "Admin",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 1, 13, 15, 39, 144, DateTimeKind.Utc).AddTicks(7776),
                            CreatedUser = "Admin",
                            IsDeleted = false,
